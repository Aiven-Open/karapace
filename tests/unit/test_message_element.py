...
def test_add_multiple_types():
    nested1 = MessageElement(
        location=location,
        name="Nested1")
    nested2 = MessageElement(
        location=location,
        name="Nested2")
    element = MessageElement(
        location=location,
...
def test_multiple_everything_to_schema():
    ...
    one_off_1_field = FieldElement(
        location=location,
        element_type="string",
        name="namey",
        tag=3
    )
    one_of_1 = OneOfElement(
        name="thingy",
        fields=[one_off_1_field]
    )
    one_off_2_field = FieldElement(
        location=location,
        element_type="string",
        name="namer",
        tag=4
    )
    one_of_2 = OneOfElement(
        name="thinger",
        fields=[one_off_2_field]
    )
